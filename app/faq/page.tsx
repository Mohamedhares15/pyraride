                  ...
                  answer={
                    <>
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        <li><span className="text-green-400">48+ hours before:</span> 100% refund</li>
                        <li><span className="text-yellow-400">24-48 hours before:</span> 50% refund</li>
                        <li><span className="text-red-400">Less than 24 hours:</span> No refund</li>
                      </ul>
                      <p className="mt-2">
