...
export const metadata: Metadata = {
  title: "Frequently Asked Questions | PyraRides - Horse Riding at Pyramids",
  ...
  keywords: [
    ...
    "PyraRides cancellation policy",
    "horse riding prices Giza",
    "best time for horse riding pyramids"
  ],
  openGraph: {
    title: "Frequently Asked Questions | PyraRides",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "PyraRides FAQ - Horse Riding at the Pyramids",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "PyraRides FAQ - Your Questions Answered",
